...
class Address:
    ...
    def create_table(self):
        table_schema = ', '.join([PrimaryKeyField(column='id').data_type(),
                                  IntegerField(column='address_id').data_type(),
                                  IntegerField(column='user_id').data_type(),
                                  CharField(column='name', max_length=200).data_type(),
                                  ...
                                  IntegerField(column='primary_address').data_type(),
                                  TextField(column='concierge_name').data_type(),
                                  TextField(column='concierge_number').data_type(),
