...
from models.server import sync_from_server
from models.server import update_database
from models.printers import Printer
from models.profiles import Profile
from models.reward_transactions import RewardTransaction
...
class Sync:
    ...
    def get_chunk(self, table=None, start=0, end=1000, *args, **kwargs):
        company_id = 1
